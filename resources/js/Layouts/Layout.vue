...
<template>
    <div class="flex">
        <div class="w-64  h-screen">
            <aside
                class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto  border-r rtl:border-r-0 rtl:border-l  ">
                <a href="#">
                ...
                <div class="relative mt-6">
                    ...
                    <input type="text"
                        class="w-full py-2 pl-10 pr-4 text-gray-700  border rounded-md    focus:border-blue-400  focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring"
                        placeholder="Search" />
                </div>
    ...
    <div class="w-full bg-slate-700">
        <div class="w-full bg-violet-500">header</div>
        <div class="w-full bg-red-600">content</div>
    </div>
</div></template>